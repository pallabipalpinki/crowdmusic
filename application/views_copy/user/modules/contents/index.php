						...
						<div class="col-lg-auto">
							<div class="profile-bg left-inner text-center">
								<div class="user-meta">
									...
									<img src="<?php echo $image; ?>" width="160" height="160" class="rounded-circle img-fluid mb-4">
									<h4 class="profile-heading"><?php echo ucwords($user_details['firstname']); ?> <?php echo ucwords($user_details['lastname']); ?></h4>
									<p><?php echo $user_details['user_rolename'];?></p>
									<?php
									if(!empty($user_details['address'])){
										?>
										<p><img src="<?php echo base_url('assets/images/map-pin.svg');?>" alt=""><?php echo $user_details['address'];?></p>
										<?php
									}
									?>
								</div>
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade show active" id="pills-album" role="tabpanel" aria-labelledby="pills-home-tab">
									<div class="row" id="album_div">
										<div class="col-lg-4 col-sm-6 mb-4"><div class="top-item"><img src="<?php echo base_url();?>assets/images/innerimg6.jpg" /></div></div>
										<div class="col-lg-4 col-sm-6 mb-4"><div class="top-item"><img src="<?php echo base_url();?>assets/images/innerimg5.jpg" /></div></div>
										<div class="col-lg-4 col-sm-6 mb-4"><div class="top-item"><img src="<?php echo base_url();?>assets/images/innerimg4.jpg" /></div></div>
										<div class="col-lg-4 col-sm-6 mb-4"><div class="top-item"><img src="<?php echo base_url();?>assets/images/innerimg1.jpg" /></div></div>
										<div class="col-lg-4 col-sm-6 mb-4"><div class="top-item"><img src="<?php echo base_url();?>assets/images/innerimg2.jpg" /></div></div>
										<div class="col-lg-4 col-sm-6 mb-4"><div class="top-item"><img src="<?php echo base_url();?>assets/images/innerimg3.jpg" /></div></div>
									</div>
								</div>
