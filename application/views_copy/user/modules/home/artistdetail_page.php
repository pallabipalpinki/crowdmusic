        ...
        <div class="row">
          <div class="col-lg-auto">
            <div class="profile-bg left-inner text-center">
              <div class="user-meta">
                <img src="<?php echo $artist_details['user_profile_image'] ?>"  width="160" height="160" class="rounded-circle img-fluid mb-4">
                <h4 class="profile-heading"><?php echo $artist_details['user_name'];?></h4>
                <p><?php echo ucwords($artist_details['user_role'])?></p>
                <p>
                  <img src="<?php echo base_url('assets/images/map-pin.svg');?>" alt="">
                  <?php echo $artist_details['user_address']?>
                </p>
              </div>
              <div class="btns">
              ...
              <div class="m_bottom_30 m_top_30">
                <div class="row">
                  <div class="col-auto">Lorem</div>
                  <div class="col-auto ml-auto">650</div>
                </div>
              </div>
              <div class="m_bottom_30 m_top_30">
                <div class="row">
              ...
              <div class="own_profile_text">
                ...
                <p><?=$artist[0]['about']?> </p>
                <a href="#" class="btn btn_blue my-3">Member since <b><?=date('jS F Y', strtotime($artist[0]['created_at']))?></b> </a> 
              </div>
            </div>
          </div>
                  ...
                  <?php
                    if(!empty($artist_tracks)){
                    	 foreach ($artist_tracks as $key => $value) {
                    			?>
                          <div class="col-lg-4 col-sm-6 mb-4">
                            <button class="like-track <?php echo $value['content_thumbs'];?>"  data-track="<?php echo $value['content_id'];?>" data-artist="<?php echo $value['content_user_id'];?>"><i class="<?php echo $value['content_thumbs_icon'];?>" id="thumbs<?php echo $value['content_id'];?>"></i></button>
