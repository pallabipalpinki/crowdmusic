         ...
         if(!empty($tracks)){
            foreach ($tracks as $key => $value) {
               ...
               <div class="col-6 col-md-4 col-lg-3 onview">
                <button class="like_track <?php echo $value['content_thumbs'];?>"  data-track="<?php echo $value['content_id'];?>" data-artist="<?php echo $value['content_user_id'];?>"><i class="<?php echo $value['content_thumbs_icon'];?>" id="thumbs<?php echo $value['content_id'];?>"></i></button>
