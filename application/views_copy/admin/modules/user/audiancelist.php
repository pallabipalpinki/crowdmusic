          ...
          <!-- <div class="col-md-6"> -->
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">AUDIANCE LIST</h3>
                  <?php
              ...
              <div class="card-body">
                ...
                <table id="audianceid" class="table table-bordered">
                  <thead>                  
                    <tr>
                  ...
                  <tbody>
                     ...
                     <a class="btn btn-danger btn-sm" href="#!" title="delete" onclick="myUserDelete('<?=base_url('admin/user-delete/'.$user['id'])?>', '<?= $user['id']?>')"><i class="fas fa-trash"> </i> Delete</a>
                      </td>
                    </tr>
                    <?php $i++; }} ?>
                  </tbody>
