        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="categoryaddform" action="<?= base_url('admin-save-category') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                    <label>Upload Your Category image</label><br>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" id="adcategorybtn">Submit</button>
                </div>
