					...
					<div class="col-lg-4">
						...
						foreach ($user_details['user_tracks'] as $key => $value) {
							...
							<li class="active" data-cover="<?php echo $value->content_image;?>" data-source="<?php echo $value->content_track;?>"><?php echo $value->content_track_name;?></li>
								<!-- <li class="active" data-cover="<?php echo base_url('assets/images/innerimg2.jpg'); ?>" data-source="<?php echo base_url('assets/80s_vibe.mp3'); ?>">ABC title</li>
								<li data-cover="<?php echo base_url('assets/images/innerimg4.jpg'); ?>" data-source="<?php echo base_url('assets/ground_truth.wav'); ?>">List 2</li>
								<li data-cover="<?php echo base_url('assets/images/innerimg1.jpg'); ?>" data-source="<?php echo base_url('assets/80s_vibe.mp3'); ?>">The song name in short</li> -->
						...
						<?php 						
						foreach ($genresofuser as $key => $value) {
							//print_r($value);
							?>
							|<a href="#"><?= $value['genere_name'] ?></a>|
						
							<!-- <a href="#">Genre 1</a>, <a href="#">Genre 2</a>, <a href="#">Genre 3</a>, <a href="#">Genre 4</a>, <a href="#">Genre 5</a>, <a href="#">Genre 6</a> -->
							<?php
						}						
						?>
						</div>
