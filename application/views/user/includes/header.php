        ...
        <div class="header-top text-right">
          <div class="container-fluid">
            ...
            <div class="header-social">
              <?php if($this->session->userdata('SESSION_USER_ID')){ ?>
            <a href="javascript:void(0);" style="text-decoration: none;"><p>Welcome <?php echo $this->session->userdata('SESSION_USER_Firstname').' . . . ';?></p></a>
               <?php } ?>
              <a href="#">
                  ...
                  <div class="socials vc">
                    <div class="search-group">
                      ...
                      <div class="search-fields">
                        <!-- <form action=""> -->
                        <input type="text" class="form-control" id="search_params" placeholder="Search here...">
