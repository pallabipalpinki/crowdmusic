<section class="inner-pg">
          ...
          <div class="profile-bg left-inner">
            ...
            <div class="col-auto"><img src="<?php echo $user_details['user_profile_image']; ?>" id="img_profile" width="120" class="rounded-circle img-fluid" loading="lazy"></div>
            <h4 class="profile-heading"><?php echo $user_details['user_name']; ?></h4>
            <h5><?php echo $user_details['user_role'];?> </h5>
              ...
              <a href="#" class="btn btn_blue my-3">Member since  <?php echo $user_details['user_created_at'];?></a> 
						...
						<div class="col-md-9 col-lg-9 right-inner">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="btn-group">
										<button type="button" class="btn btn-xs btn-primary custom_button btn_options active" id="btn_album_div" data-target="album_div">Albums</button>
										<button type="button" class="btn btn-xs btn-primary custom_button btn_options" id="btn_tracks_div" data-target="tracks_div">Tracks</button>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="btn-group" style="float:right;">
										<a href="#contentsModalId" id="upload_button" data-toggle="modal" type="button" class="btn btn-xs btn-primary custom_button active">Upload</a>
									</div>
								</div>
