											  ...
											  <div class="feature-list text-center">
												 ...
												 <?php
								                    if($value['content_user_id']!=session_userdata('SESSION_USER_ID')){
								                     ?>
								                     <label class="caption lbl_caption" data-track_user="<?php echo $value['content_user_id'];?>" data-track="<?php echo $value['content_id']; ?>" data-toggle="modal" data-target="#commentModalId"><a href="<?php echo $value['artists_profile'];?>">By-<?php echo $value['content_track_user_name'];?></a></label>
								                     <?php
								                    }else{
								                     ?>
