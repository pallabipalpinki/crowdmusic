									...
									<div class="col-md-3">
										<div class="artist-item">
										  <div class="ai-img-wrapper">
											<img src="<?php echo $value['artists_image'];?>" class="img-responsive" loading="lazy"/>
										  </div>
										  <div class="artist-box">
											<h3><?php echo $value['artists_name'];?></a></h3>
											<div class="ai-price"><a href="<?php echo $value['artists_profile'];?>">View Profile</a></div>
											<ul class="rating">
