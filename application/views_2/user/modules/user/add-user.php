               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <textarea class="textarea form-control" id="address" name="address" placeholder="Enter Your Address" value="" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                     ...
                     <div class="form-group col-md-12" id="user_spec" style="display:none;">
